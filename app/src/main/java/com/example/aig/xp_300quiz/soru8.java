...
public class soru8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soru8);
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                editor.commit();
                Intent next = new Intent(getApplicationContext(), soru9.class);
                startActivity(next);
            }
        }.start();
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
                Intent soru9 = new Intent(getApplicationContext(), soru9.class);
                startActivity(soru9);
