...
public class soru10 extends AppCompatActivity {
    RadioButton ans1;
    RadioButton ans2;
    RadioButton ans3;
    RadioButton ans4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CountDownTimer countDownTimer = new CountDownTimer(60000,1000) {
            ...
            public void onFinish() {
                ...
                editor.commit();
                Intent son = new Intent(getApplicationContext(), sonsayfa.class);
                startActivity(son);
        ...
        public void onClick(View v) {
            ...
            editor.commit();
            Intent sonsayfa = new Intent(getApplicationContext(), sonsayfa.class);
            startActivity(sonsayfa);
