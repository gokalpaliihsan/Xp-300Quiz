...
public class soru9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soru9);
        ...
        final CountDownTimer countdowntimer = new CountDownTimer(60000,1000) {
            ...
            public void onFinish() {
                ...
                editor.commit();
                Intent soru10 = new Intent(getApplicationContext(), soru10.class);
                startActivity(soru10);
